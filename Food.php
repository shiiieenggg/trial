...
<!-- Category Title -->
<div class="Title">
        <h1 class="Title"> <a href="index.php#Category"><img class="icon" src="images/petfood.png" alt="food" height="70" width="70"></a> Food</h1>
</div>
...
<div class="Pet">
        <div class="row">
            ...
            <div class="col-6 Pet2">
                <h5> <a href="Food(dog).php">Dog</a></h5>
            </div>
        </div>
...
<script src="js/foodsCat.js"></script>
<script src="js/app js/appFoodCat.js"></script>
