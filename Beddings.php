...
<!--Category Title-->
<div class="Title">
        <h1 class="Title"> <a href="index.php#Category"><img class="icon" src="images/bedding.png" alt="food" height="70" width="70"></a> Bedding</h1>
</div>
...
<div class="Pet">
        <div class="row">
            ...
            <div class="col-6 Pet2">
                <h5> <a href="Beddings(dog).php">Dog</a></h5>
            </div>
        </div>
</div>
...
<script src="js/beddingsCat.js"></script>
<script src="js/app js/appBedCat.js"></script>
</body>
</html>
