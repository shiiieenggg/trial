...
<body>
                            ...
                            <div class = "cart">
                               <!-- Button trigger modal -->
                                     <button type="button" class="btn btn-primary cart-btn" data-bs-toggle="modal" data-bs-target="#cart">
                                          <i class="fas fa-shopping-cart"></i> <span class = "total-items-in-cart">0</span>
                                                   </button>
                                                         <!-- Modal -->
                                                               <div class="modal fade" id="cart" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                                    <div class="modal-dialog">
                                                                      <div class="modal-content">
                                                                        ...
                                                                        <button type="button" class="btn btn-primary cart-btn" data-bs-toggle="modal" data-bs-target="#cart"> Check Out</button>
                                                                        </div>
                                                                      </div>
                                                                    </div>
                                                                  </div>
  ...
  <!--Category Title-->
  <div class="Title">
        <h1 class="Title"><a href="index.php#Category"> <img class="icon" src="images\accesories.png" alt="accessories" height="70" width="70"></a> Accessories</h1>
  </div>
  ...
  <div class="Pet">
        <div class="row">
            ...
            <div class="col-6 Pet2">
                <h5> <a href="Accesories(dog).php">Dog</a></h5>
            </div>
        </div>
...
<script src="js/accessoriesCat.js"></script>
<script src="js/app js/appAccCat.js"></script>
