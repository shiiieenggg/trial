...
<div class = "wishlist">
  ...
  <!--Category Title-->
  <div class="Title">
        <h1 class="Title"><a href="index.php#Category"> <img class="icon" src="images/pills.png" alt="food" height="70" width="70"></a> Dog</h1>
  </div>
                ...
                <div class="collapse navbar-collapse" id="categories">
                    <ul class="navbar-nav ms-auto">
                        <li class="nav-item " id = "categories-item" >
                            <a class="nav-link" href="DogFood.php">Food</a>
                        </li>

                        <li class="nav-item" id = "categories-item">
                            <a class="nav-link" href="Dogmed.php">Medicine</a>
                        </li>

                        <li class="nav-item" id = "categories-item">
                            <a class="nav-link" href="Dogbed.php">Beddings</a>
                        </li>

                        <li class="nav-item" id = "categories-item">
                            <a class="nav-link" href="Dogtoy.php">Toy</a>
                        </li>

                        <li class="nav-item" id = "categories-item">
                            <a class="nav-link" href="Dogacc.php">Accessories</a>
                        </li>
                        <li class="nav-item" id = "categories-item">
                            <a class="nav-link" href="Dogsan.php">Sanitation</a>
                        </li>
...
<script src="js/medicineDog.js"></script>
<script src="js/app js/appMedDog.js"></script>
</body>
</html>
